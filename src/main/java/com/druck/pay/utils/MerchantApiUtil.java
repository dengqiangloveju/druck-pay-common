...
public class MerchantApiUtil {
    ...
    public static String  getSign (Map<String , Object> paramMap , String paySecret){
        ...
        for (Map.Entry<String, Object> m : smap.entrySet()) {
            ...
            if (CommonUtils.isNotEmpty(String.valueOf(value))){
    ...
    public static boolean isRightSign(Map<String , Object> paramMap , String paySecret ,String signStr){
        if (CommonUtils.isEmpty(signStr)){
            return false;
        }
     ...
     * @return 提交表单HTML文本
     */
    public static String buildRequest(Map<String, Object> sParaTemp, String url, String strMethod, String strButtonName) {
        //待请求参数数组
        List<String> keys = new ArrayList<String>(sParaTemp.keySet());
        StringBuffer sbHtml = new StringBuffer();

        sbHtml.append("<form id=\"rppaysubmit\" name=\"rppaysubmit\" action=\"" + url + "\" method=\"" + strMethod
                + "\">");
